...
module chip_earlgrey_asic #(
  ...
  inout IOR9, // MIO Pad 43
  inout IOR10, // MIO Pad 44
  inout IOR11, // MIO Pad 45
  inout IOR12, // MIO Pad 46
  inout IOR13  // MIO Pad 47
);
  ...
  padring #(
    ...
    .MioScanRole ({
      ...
      scan_role_pkg::MioPadIor9ScanRole,
...
`endif
    ...
    .mio_in_o (mio_in[47:0]),
    .mio_out_i (mio_out[47:0]),
    .mio_oe_i (mio_oe[47:0]),
    .mio_attr_i (mio_attr[47:0]),
    .mio_in_raw_o (mio_in_raw[47:0])
  );
