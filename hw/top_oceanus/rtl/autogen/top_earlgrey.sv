...
// pragma coverage off
    ...
    assign unused_rst_en_20 = rstmgr_aon_rst_en.data_proc[rstmgr_pkg::DomainAonSel];
...
// pragma coverage on
  ...
  flash_ctrl #(
    .AlertAsyncOn(alert_handler_reg_pkg::AsyncOn[33:29]),
    ...
    .RdFifoDepth(FlashCtrlRdFifoDepth)
      ...
      // [30]: fatal_std_err
      // [31]: fatal_err
      // [32]: fatal_prim_flash_alert
      // [33]: recov_prim_flash_alert
      .alert_tx_o  ( alert_tx[33:29] ),
      .alert_rx_i  ( alert_rx[33:29] ),
  ...
  assign intr_vector = {
      intr_flash_ctrl_corr_err, // IDs [99 +: 1]
      intr_flash_ctrl_op_done, // IDs [98 +: 1]
      intr_flash_ctrl_rd_lvl, // IDs [97 +: 1]
      intr_flash_ctrl_rd_full, // IDs [96 +: 1]
      intr_flash_ctrl_prog_lvl, // IDs [95 +: 1]
      intr_flash_ctrl_prog_empty, // IDs [94 +: 1]
      intr_sensor_ctrl_aon_init_status_change, // IDs [93 +: 1]
      intr_sensor_ctrl_aon_io_status_change, // IDs [92 +: 1]
      intr_aon_timer_aon_wdog_timer_bark, // IDs [91 +: 1]
      intr_aon_timer_aon_wkup_timer_expired, // IDs [90 +: 1]
      intr_adc_ctrl_aon_match_done, // IDs [89 +: 1]
      intr_sysrst_ctrl_aon_event_detected, // IDs [88 +: 1]
      intr_pwrmgr_aon_wakeup, // IDs [87 +: 1]
      intr_spi_host0_spi_event, // IDs [86 +: 1]
      intr_spi_host0_error, // IDs [85 +: 1]
      intr_alert_handler_classd, // IDs [84 +: 1]
      intr_alert_handler_classc, // IDs [83 +: 1]
      intr_alert_handler_classb, // IDs [82 +: 1]
      intr_alert_handler_classa, // IDs [81 +: 1]
