...
// pragma coverage off
    ...
    assign unused_cg_en_8 = clkmgr_aon_cg_en.io_div2_peri;
...
// pragma coverage on
  ...
  otp_ctrl #(
    ...
    .RndCnstScrmblKeyInit(RndCnstOtpCtrlScrmblKeyInit)
      ...
      // [9]: fatal_prim_otp_alert
      // [10]: recov_prim_otp_alert
      .alert_tx_o  ( alert_tx[10:6] ),
      .alert_rx_i  ( alert_rx[10:6] ),
  ...
  flash_ctrl #(
    .AlertAsyncOn(alert_handler_reg_pkg::AsyncOn[32:28]),
    ...
    .RdFifoDepth(FlashCtrlRdFifoDepth)
      ...
      // [29]: fatal_std_err
      // [30]: fatal_err
      // [31]: fatal_prim_flash_alert
      // [32]: recov_prim_flash_alert
      .alert_tx_o  ( alert_tx[32:28] ),
      .alert_rx_i  ( alert_rx[32:28] ),
  ...
  assign intr_vector = {
      intr_flash_ctrl_corr_err, // IDs [91 +: 1]
      intr_flash_ctrl_op_done, // IDs [90 +: 1]
      intr_flash_ctrl_rd_lvl, // IDs [89 +: 1]
      intr_flash_ctrl_rd_full, // IDs [88 +: 1]
      intr_flash_ctrl_prog_lvl, // IDs [87 +: 1]
      intr_flash_ctrl_prog_empty, // IDs [86 +: 1]
      intr_sensor_ctrl_aon_init_status_change, // IDs [85 +: 1]
      intr_sensor_ctrl_aon_io_status_change, // IDs [84 +: 1]
      ...
      intr_alert_handler_classd, // IDs [76 +: 1]
      intr_alert_handler_classc, // IDs [75 +: 1]
      intr_alert_handler_classb, // IDs [74 +: 1]
      intr_alert_handler_classa, // IDs [73 +: 1]
      intr_otp_ctrl_otp_error, // IDs [72 +: 1]
      intr_otp_ctrl_otp_operation_done, // IDs [71 +: 1]
      intr_rv_timer_timer_expired_hart0_timer0, // IDs [70 +: 1]
      intr_pattgen_done_ch1, // IDs [69 +: 1]
      intr_pattgen_done_ch0, // IDs [68 +: 1]
