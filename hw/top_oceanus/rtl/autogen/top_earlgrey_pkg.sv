...
package top_earlgrey_pkg;
   ...
   */
  parameter int unsigned TOP_EARLGREY_DATA_PROC_BASE_ADDR = 32'h40000000;
   ...
   */
  parameter int unsigned TOP_EARLGREY_UART0_BASE_ADDR = 32'h44000000;
  ...
  typedef enum int unsigned {
    ...
    TopEarlgreyAlertPeripheralPwrmgrAon = 10,
    TopEarlgreyAlertPeripheralRstmgrAon = 11,
    TopEarlgreyAlertPeripheralClkmgrAon = 12,
    TopEarlgreyAlertPeripheralSysrstCtrlAon = 13,
    TopEarlgreyAlertPeripheralAdcCtrlAon = 14,
    TopEarlgreyAlertPeripheralPwmAon = 15,
    TopEarlgreyAlertPeripheralPinmuxAon = 16,
    TopEarlgreyAlertPeripheralAonTimerAon = 17,
    TopEarlgreyAlertPeripheralSensorCtrlAon = 18,
    TopEarlgreyAlertPeripheralSramCtrlRetAon = 19,
    TopEarlgreyAlertPeripheralFlashCtrl = 20,
    TopEarlgreyAlertPeripheralRvDm = 21,
    TopEarlgreyAlertPeripheralRvPlic = 22,
    TopEarlgreyAlertPeripheralSramCtrlMain = 23,
    TopEarlgreyAlertPeripheralRomCtrl = 24,
    TopEarlgreyAlertPeripheralRvCoreIbex = 25,
  ...
  typedef enum int unsigned {
    ...
    TopEarlgreyAlertIdSysrstCtrlAonFatalFault = 21,
    TopEarlgreyAlertIdAdcCtrlAonFatalFault = 22,
    TopEarlgreyAlertIdPwmAonFatalFault = 23,
    TopEarlgreyAlertIdPinmuxAonFatalFault = 24,
    TopEarlgreyAlertIdAonTimerAonFatalFault = 25,
    TopEarlgreyAlertIdSensorCtrlAonRecovAlert = 26,
    TopEarlgreyAlertIdSensorCtrlAonFatalAlert = 27,
    TopEarlgreyAlertIdSramCtrlRetAonFatalError = 28,
    TopEarlgreyAlertIdFlashCtrlRecovErr = 29,
    TopEarlgreyAlertIdFlashCtrlFatalStdErr = 30,
    TopEarlgreyAlertIdFlashCtrlFatalErr = 31,
    TopEarlgreyAlertIdFlashCtrlFatalPrimFlashAlert = 32,
    TopEarlgreyAlertIdFlashCtrlRecovPrimFlashAlert = 33,
    TopEarlgreyAlertIdRvDmFatalFault = 34,
    TopEarlgreyAlertIdRvPlicFatalFault = 35,
    TopEarlgreyAlertIdSramCtrlMainFatalError = 36,
    TopEarlgreyAlertIdRomCtrlFatal = 37,
    TopEarlgreyAlertIdRvCoreIbexFatalSwErr = 38,
    TopEarlgreyAlertIdRvCoreIbexRecovSwErr = 39,
    TopEarlgreyAlertIdRvCoreIbexFatalHwErr = 40,
    TopEarlgreyAlertIdRvCoreIbexRecovHwErr = 41,
