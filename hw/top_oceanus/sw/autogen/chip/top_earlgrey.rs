...
pub const DATA_PROC_BASE_ADDR: usize = 0x60500000;
...
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const UART0_BASE_ADDR: usize = 0x80000000;
...
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const GPIO_BASE_ADDR: usize = 0x80010000;
...
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const SPI_DEVICE_BASE_ADDR: usize = 0x80020000;
...
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const I2C0_BASE_ADDR: usize = 0x80030000;
...
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const PATTGEN_BASE_ADDR: usize = 0x90000000;
...
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const RV_TIMER_BASE_ADDR: usize = 0x90010000;
...
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const OTP_CTRL_CORE_BASE_ADDR: usize = 0xA0000000;
...
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const OTP_CTRL_PRIM_BASE_ADDR: usize = 0xB0001000;
...
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const SPI_HOST0_BASE_ADDR: usize = 0x70100000;
...
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const PWRMGR_AON_BASE_ADDR: usize = 0x80040000;
...
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const RSTMGR_AON_BASE_ADDR: usize = 0x80050000;
...
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const CLKMGR_AON_BASE_ADDR: usize = 0x80060000;
...
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const SYSRST_CTRL_AON_BASE_ADDR: usize = 0x80070000;
...
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const ADC_CTRL_AON_BASE_ADDR: usize = 0x80080000;
...
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const PWM_AON_BASE_ADDR: usize = 0x80090000;
...
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const PINMUX_AON_BASE_ADDR: usize = 0x800A0000;
...
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const AON_TIMER_AON_BASE_ADDR: usize = 0x800B0000;
...
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const LC_CTRL_BASE_ADDR: usize = 0x800C0000;
...
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const SRAM_CTRL_RET_AON_REGS_BASE_ADDR: usize = 0x60400000;
...
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const SRAM_CTRL_RET_AON_RAM_BASE_ADDR: usize = 0x60000000;
...
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const RV_DM_REGS_BASE_ADDR: usize = 0x60300000;
...
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const SRAM_CTRL_MAIN_REGS_BASE_ADDR: usize = 0x60200000;
...
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const ROM_CTRL_REGS_BASE_ADDR: usize = 0x60600000;
...
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const RV_CORE_IBEX_CFG_BASE_ADDR: usize = 0x60700000;
...
pub const RAM_RET_AON_BASE_ADDR: usize = 0x60000000;
...
pub enum PlicIrqId {
    ...
    SysrstCtrlAonEventDetected = 84,
    /// adc_ctrl_aon_match_done
    AdcCtrlAonMatchDone = 85,
    /// aon_timer_aon_wkup_timer_expired
    AonTimerAonWkupTimerExpired = 86,
    /// aon_timer_aon_wdog_timer_bark
    AonTimerAonWdogTimerBark = 87,
}
...
impl TryFrom<u32> for PlicIrqId {
    ...
    fn try_from(val: u32) -> Result<Self, Self::Error> {
        match val {
            ...
            81 => Ok(Self::SpiHost0Error),
            82 => Ok(Self::SpiHost0SpiEvent),
            83 => Ok(Self::PwrmgrAonWakeup),
            84 => Ok(Self::SysrstCtrlAonEventDetected),
            85 => Ok(Self::AdcCtrlAonMatchDone),
            86 => Ok(Self::AonTimerAonWkupTimerExpired),
            87 => Ok(Self::AonTimerAonWdogTimerBark),
            _ => Err(val),
        }
    }
}
...
pub enum AlertId {
    ...
    LcCtrlFatalProgError = 23,
    /// lc_ctrl_fatal_state_error
    LcCtrlFatalStateError = 24,
    /// lc_ctrl_fatal_bus_integ_error
    LcCtrlFatalBusIntegError = 25,
    /// sram_ctrl_ret_aon_fatal_error
    SramCtrlRetAonFatalError = 26,
    /// rv_dm_fatal_fault
    RvDmFatalFault = 27,
    /// rv_plic_fatal_fault
    RvPlicFatalFault = 28,
    /// sram_ctrl_main_fatal_error
    SramCtrlMainFatalError = 29,
    /// rom_ctrl_fatal
    RomCtrlFatal = 30,
    /// rv_core_ibex_fatal_sw_err
    RvCoreIbexFatalSwErr = 31,
    /// rv_core_ibex_recov_sw_err
    RvCoreIbexRecovSwErr = 32,
    /// rv_core_ibex_fatal_hw_err
    RvCoreIbexFatalHwErr = 33,
    /// rv_core_ibex_recov_hw_err
    RvCoreIbexRecovHwErr = 34,
}
...
impl TryFrom<u32> for AlertId {
    ...
    fn try_from(val: u32) -> Result<Self, Self::Error> {
        match val {
            ...
            18 => Ok(Self::SysrstCtrlAonFatalFault),
            19 => Ok(Self::AdcCtrlAonFatalFault),
            20 => Ok(Self::PwmAonFatalFault),
            21 => Ok(Self::PinmuxAonFatalFault),
            22 => Ok(Self::AonTimerAonFatalFault),
            23 => Ok(Self::LcCtrlFatalProgError),
            24 => Ok(Self::LcCtrlFatalStateError),
            25 => Ok(Self::LcCtrlFatalBusIntegError),
            26 => Ok(Self::SramCtrlRetAonFatalError),
            27 => Ok(Self::RvDmFatalFault),
            28 => Ok(Self::RvPlicFatalFault),
            29 => Ok(Self::SramCtrlMainFatalError),
            30 => Ok(Self::RomCtrlFatal),
            31 => Ok(Self::RvCoreIbexFatalSwErr),
            32 => Ok(Self::RvCoreIbexRecovSwErr),
            33 => Ok(Self::RvCoreIbexFatalHwErr),
            34 => Ok(Self::RvCoreIbexRecovHwErr),
            _ => Err(val),
        }
    }
}
...
/// `AlertPeripheral`.
pub const ALERT_FOR_PERIPHERAL: [AlertPeripheral; 35] = [
...
pub const NUM_MIO_PADS: usize = 48;
pub const NUM_DIO_PADS: usize = 13;
...
pub enum PinmuxOutsel {
    ...
    SysrstCtrlAonBatDisable = 39,
    /// Peripheral Output 37
    SysrstCtrlAonKey0Out = 40,
    /// Peripheral Output 38
    SysrstCtrlAonKey1Out = 41,
    /// Peripheral Output 39
    SysrstCtrlAonKey2Out = 42,
    /// Peripheral Output 40
    SysrstCtrlAonPwrbOut = 43,
    /// Peripheral Output 41
    SysrstCtrlAonZ3Wakeup = 44,
}
...
impl TryFrom<u32> for PinmuxOutsel {
    ...
    fn try_from(val: u32) -> Result<Self, Self::Error> {
        match val {
            ...
            39 => Ok(Self::SysrstCtrlAonBatDisable),
            40 => Ok(Self::SysrstCtrlAonKey0Out),
            41 => Ok(Self::SysrstCtrlAonKey1Out),
            42 => Ok(Self::SysrstCtrlAonKey2Out),
            43 => Ok(Self::SysrstCtrlAonPwrbOut),
            44 => Ok(Self::SysrstCtrlAonZ3Wakeup),
            _ => Err(val),
        }
    }
}
...
impl TryFrom<u32> for DirectPads {
    ...
    fn try_from(val: u32) -> Result<Self, Self::Error> {
        match val {
            ...
            9 => Ok(Self::SpiDeviceSck),
            10 => Ok(Self::SpiDeviceCsb),
            11 => Ok(Self::SpiHost0Sck),
            12 => Ok(Self::SpiHost0Csb),
            _ => Err(val),
        }
    }
}
...
pub const MMIO_BASE_ADDR: usize = 0x40480000;
pub const MMIO_SIZE_BYTES: usize = 0x6FB81020;
