 ...
 */
#define TOP_EARLGREY_ALERT_HANDLER_SIZE_BYTES 0x400u
...
typedef enum top_earlgrey_plic_peripheral {
  ...
  kTopEarlgreyPlicPeripheralPattgen = 5, /**< pattgen */
  kTopEarlgreyPlicPeripheralRvTimer = 6, /**< rv_timer */
  ...
  kTopEarlgreyPlicPeripheralSensorCtrlAon = 14, /**< sensor_ctrl_aon */
  kTopEarlgreyPlicPeripheralFlashCtrl = 15, /**< flash_ctrl */
  kTopEarlgreyPlicPeripheralLast = 15, /**< \internal Final PLIC peripheral */
...
typedef enum top_earlgrey_plic_irq_id {
  ...
  kTopEarlgreyPlicIrqIdPattgenDoneCh0 = 68, /**< pattgen_done_ch0 */
  kTopEarlgreyPlicIrqIdPattgenDoneCh1 = 69, /**< pattgen_done_ch1 */
  kTopEarlgreyPlicIrqIdRvTimerTimerExpiredHart0Timer0 = 70, /**< rv_timer_timer_expired_hart0_timer0 */
  kTopEarlgreyPlicIrqIdOtpCtrlOtpOperationDone = 71, /**< otp_ctrl_otp_operation_done */
  kTopEarlgreyPlicIrqIdOtpCtrlOtpError = 72, /**< otp_ctrl_otp_error */
  kTopEarlgreyPlicIrqIdAlertHandlerClassa = 73, /**< alert_handler_classa */
  kTopEarlgreyPlicIrqIdAlertHandlerClassb = 74, /**< alert_handler_classb */
  kTopEarlgreyPlicIrqIdAlertHandlerClassc = 75, /**< alert_handler_classc */
  kTopEarlgreyPlicIrqIdAlertHandlerClassd = 76, /**< alert_handler_classd */
  kTopEarlgreyPlicIrqIdSpiHost0Error = 77, /**< spi_host0_error */
  kTopEarlgreyPlicIrqIdSpiHost0SpiEvent = 78, /**< spi_host0_spi_event */
  kTopEarlgreyPlicIrqIdPwrmgrAonWakeup = 79, /**< pwrmgr_aon_wakeup */
  kTopEarlgreyPlicIrqIdSysrstCtrlAonEventDetected = 80, /**< sysrst_ctrl_aon_event_detected */
  kTopEarlgreyPlicIrqIdAdcCtrlAonMatchDone = 81, /**< adc_ctrl_aon_match_done */
  kTopEarlgreyPlicIrqIdAonTimerAonWkupTimerExpired = 82, /**< aon_timer_aon_wkup_timer_expired */
  kTopEarlgreyPlicIrqIdAonTimerAonWdogTimerBark = 83, /**< aon_timer_aon_wdog_timer_bark */
  kTopEarlgreyPlicIrqIdSensorCtrlAonIoStatusChange = 84, /**< sensor_ctrl_aon_io_status_change */
  kTopEarlgreyPlicIrqIdSensorCtrlAonInitStatusChange = 85, /**< sensor_ctrl_aon_init_status_change */
  kTopEarlgreyPlicIrqIdFlashCtrlProgEmpty = 86, /**< flash_ctrl_prog_empty */
  kTopEarlgreyPlicIrqIdFlashCtrlProgLvl = 87, /**< flash_ctrl_prog_lvl */
  kTopEarlgreyPlicIrqIdFlashCtrlRdFull = 88, /**< flash_ctrl_rd_full */
  kTopEarlgreyPlicIrqIdFlashCtrlRdLvl = 89, /**< flash_ctrl_rd_lvl */
  kTopEarlgreyPlicIrqIdFlashCtrlOpDone = 90, /**< flash_ctrl_op_done */
  kTopEarlgreyPlicIrqIdFlashCtrlCorrErr = 91, /**< flash_ctrl_corr_err */
  kTopEarlgreyPlicIrqIdLast = 91, /**< \internal The Last Valid Interrupt ID. */
...
typedef enum top_earlgrey_alert_peripheral {
  ...
  kTopEarlgreyAlertPeripheralRvTimer = 5, /**< rv_timer */
  ...
  kTopEarlgreyAlertPeripheralRvDm = 20, /**< rv_dm */
  kTopEarlgreyAlertPeripheralRvPlic = 21, /**< rv_plic */
...
typedef enum top_earlgrey_alert_id {
  ...
  kTopEarlgreyAlertIdRvTimerFatalFault = 5, /**< rv_timer_fatal_fault */
  kTopEarlgreyAlertIdOtpCtrlFatalMacroError = 6, /**< otp_ctrl_fatal_macro_error */
  kTopEarlgreyAlertIdOtpCtrlFatalCheckError = 7, /**< otp_ctrl_fatal_check_error */
  kTopEarlgreyAlertIdOtpCtrlFatalBusIntegError = 8, /**< otp_ctrl_fatal_bus_integ_error */
  kTopEarlgreyAlertIdOtpCtrlFatalPrimOtpAlert = 9, /**< otp_ctrl_fatal_prim_otp_alert */
  kTopEarlgreyAlertIdOtpCtrlRecovPrimOtpAlert = 10, /**< otp_ctrl_recov_prim_otp_alert */
  ...
  kTopEarlgreyAlertIdSpiHost0FatalFault = 14, /**< spi_host0_fatal_fault */
  kTopEarlgreyAlertIdPwrmgrAonFatalFault = 15, /**< pwrmgr_aon_fatal_fault */
  kTopEarlgreyAlertIdRstmgrAonFatalFault = 16, /**< rstmgr_aon_fatal_fault */
  kTopEarlgreyAlertIdRstmgrAonFatalCnstyFault = 17, /**< rstmgr_aon_fatal_cnsty_fault */
  kTopEarlgreyAlertIdClkmgrAonRecovFault = 18, /**< clkmgr_aon_recov_fault */
  ...
  kTopEarlgreyAlertIdSensorCtrlAonRecovAlert = 25, /**< sensor_ctrl_aon_recov_alert */
  kTopEarlgreyAlertIdSensorCtrlAonFatalAlert = 26, /**< sensor_ctrl_aon_fatal_alert */
  kTopEarlgreyAlertIdSramCtrlRetAonFatalError = 27, /**< sram_ctrl_ret_aon_fatal_error */
  kTopEarlgreyAlertIdFlashCtrlRecovErr = 28, /**< flash_ctrl_recov_err */
  kTopEarlgreyAlertIdFlashCtrlFatalStdErr = 29, /**< flash_ctrl_fatal_std_err */
  kTopEarlgreyAlertIdFlashCtrlFatalErr = 30, /**< flash_ctrl_fatal_err */
  kTopEarlgreyAlertIdFlashCtrlFatalPrimFlashAlert = 31, /**< flash_ctrl_fatal_prim_flash_alert */
  kTopEarlgreyAlertIdFlashCtrlRecovPrimFlashAlert = 32, /**< flash_ctrl_recov_prim_flash_alert */
  kTopEarlgreyAlertIdRvDmFatalFault = 33, /**< rv_dm_fatal_fault */
  kTopEarlgreyAlertIdRvPlicFatalFault = 34, /**< rv_plic_fatal_fault */
  kTopEarlgreyAlertIdSramCtrlMainFatalError = 35, /**< sram_ctrl_main_fatal_error */
  kTopEarlgreyAlertIdRomCtrlFatal = 36, /**< rom_ctrl_fatal */
  kTopEarlgreyAlertIdRvCoreIbexFatalSwErr = 37, /**< rv_core_ibex_fatal_sw_err */
  kTopEarlgreyAlertIdRvCoreIbexRecovSwErr = 38, /**< rv_core_ibex_recov_sw_err */
  kTopEarlgreyAlertIdRvCoreIbexFatalHwErr = 39, /**< rv_core_ibex_fatal_hw_err */
  kTopEarlgreyAlertIdRvCoreIbexRecovHwErr = 40, /**< rv_core_ibex_recov_hw_err */
