...
assign alert_if[6].alert_tx = `CHIP_HIER.u_pattgen.alert_tx_o[0];
assign alert_if[7].alert_tx = `CHIP_HIER.u_rv_timer.alert_tx_o[0];
assign alert_if[8].alert_tx = `CHIP_HIER.u_otp_ctrl.alert_tx_o[0];
assign alert_if[9].alert_tx = `CHIP_HIER.u_otp_ctrl.alert_tx_o[1];
assign alert_if[10].alert_tx = `CHIP_HIER.u_otp_ctrl.alert_tx_o[2];
assign alert_if[11].alert_tx = `CHIP_HIER.u_otp_ctrl.alert_tx_o[3];
assign alert_if[12].alert_tx = `CHIP_HIER.u_otp_ctrl.alert_tx_o[4];
assign alert_if[13].alert_tx = `CHIP_HIER.u_lc_ctrl.alert_tx_o[0];
assign alert_if[14].alert_tx = `CHIP_HIER.u_lc_ctrl.alert_tx_o[1];
assign alert_if[15].alert_tx = `CHIP_HIER.u_lc_ctrl.alert_tx_o[2];
assign alert_if[16].alert_tx = `CHIP_HIER.u_spi_host0.alert_tx_o[0];
assign alert_if[17].alert_tx = `CHIP_HIER.u_spi_host1.alert_tx_o[0];
