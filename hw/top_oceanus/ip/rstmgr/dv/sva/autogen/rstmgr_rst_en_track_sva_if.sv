...
interface rstmgr_rst_en_track_sva_if (
  ...
  `ASSERT(D0RstDataProcEnTracksRstDataProcActive_A,
          $fell(resets_i.rst_data_proc_n[Domain0Sel]) |-> ##[0:DELAY]
          reset_en_i.data_proc[Domain0Sel] == prim_mubi_pkg::MuBi4True,
          clk_data_proc_i,
          !rst_por_ni)

  `ASSERT(D0RstDataProcEnTracksRstDataProcInactive_A,
          $rose(resets_i.rst_data_proc_n[Domain0Sel]) |-> ##DELAY
          !resets_i.rst_data_proc_n[Domain0Sel] ||
          reset_en_i.data_proc[Domain0Sel] == prim_mubi_pkg::MuBi4False,
          clk_data_proc_i,
          !rst_por_ni)

  `ASSERT(DAonRstDataProcEnTracksRstDataProcActive_A,
          $fell(resets_i.rst_data_proc_n[DomainAonSel]) |-> ##[0:DELAY]
          reset_en_i.data_proc[DomainAonSel] == prim_mubi_pkg::MuBi4True,
          clk_data_proc_i,
          !rst_por_ni)

  `ASSERT(DAonRstDataProcEnTracksRstDataProcInactive_A,
          $rose(resets_i.rst_data_proc_n[DomainAonSel]) |-> ##DELAY
          !resets_i.rst_data_proc_n[DomainAonSel] ||
          reset_en_i.data_proc[DomainAonSel] == prim_mubi_pkg::MuBi4False,
          clk_data_proc_i,
          !rst_por_ni)
