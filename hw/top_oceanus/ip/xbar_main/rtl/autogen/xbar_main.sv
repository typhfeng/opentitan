...
module xbar_main (
  ...
  assign tl_sm1_17_us_h2d[1] = tl_s1n_20_ds_h2d[2];
  assign tl_s1n_20_ds_d2h[2] = tl_sm1_17_us_d2h[1];

  assign tl_sm1_22_us_h2d[0] = tl_s1n_20_ds_h2d[3];
  assign tl_s1n_20_ds_d2h[3] = tl_sm1_22_us_d2h[0];

  assign tl_sm1_18_us_h2d[1] = tl_s1n_20_ds_h2d[4];
  assign tl_s1n_20_ds_d2h[4] = tl_sm1_18_us_d2h[1];

  assign tl_sm1_24_us_h2d[0] = tl_s1n_20_ds_h2d[5];
  assign tl_s1n_20_ds_d2h[5] = tl_sm1_24_us_d2h[0];

  assign tl_sm1_26_us_h2d[0] = tl_s1n_20_ds_h2d[6];
  assign tl_s1n_20_ds_d2h[6] = tl_sm1_26_us_d2h[0];

  assign tl_sm1_27_us_h2d[0] = tl_s1n_20_ds_h2d[7];
  assign tl_s1n_20_ds_d2h[7] = tl_sm1_27_us_d2h[0];

  assign tl_sm1_28_us_h2d[0] = tl_s1n_20_ds_h2d[8];
  assign tl_s1n_20_ds_d2h[8] = tl_sm1_28_us_d2h[0];

  assign tl_sm1_29_us_h2d[0] = tl_s1n_20_ds_h2d[9];
  assign tl_s1n_20_ds_d2h[9] = tl_sm1_29_us_d2h[0];

  assign tl_sm1_19_us_h2d[1] = tl_s1n_20_ds_h2d[10];
  assign tl_s1n_20_ds_d2h[10] = tl_sm1_19_us_d2h[1];

  assign tl_sm1_30_us_h2d[0] = tl_s1n_20_ds_h2d[11];
  assign tl_s1n_20_ds_d2h[11] = tl_sm1_30_us_d2h[0];

  assign tl_sm1_16_us_h2d[2] = tl_s1n_31_ds_h2d[0];
  assign tl_s1n_31_ds_d2h[0] = tl_sm1_16_us_d2h[2];

  assign tl_sm1_21_us_h2d[1] = tl_s1n_31_ds_h2d[1];
  assign tl_s1n_31_ds_d2h[1] = tl_sm1_21_us_d2h[1];

  assign tl_sm1_17_us_h2d[2] = tl_s1n_31_ds_h2d[2];
  assign tl_s1n_31_ds_d2h[2] = tl_sm1_17_us_d2h[2];

  assign tl_sm1_22_us_h2d[1] = tl_s1n_31_ds_h2d[3];
  assign tl_s1n_31_ds_d2h[3] = tl_sm1_22_us_d2h[1];

  assign tl_sm1_18_us_h2d[2] = tl_s1n_31_ds_h2d[4];
  assign tl_s1n_31_ds_d2h[4] = tl_sm1_18_us_d2h[2];
  ...
  assign tl_sm1_19_us_h2d[2] = tl_s1n_31_ds_h2d[10];
  assign tl_s1n_31_ds_d2h[10] = tl_sm1_19_us_d2h[2];

  assign tl_sm1_30_us_h2d[1] = tl_s1n_31_ds_h2d[11];
  assign tl_s1n_31_ds_d2h[11] = tl_sm1_30_us_d2h[1];

  assign tl_s1n_15_us_h2d = tl_rv_core_ibex__corei_i;
  assign tl_rv_core_ibex__corei_o = tl_s1n_15_us_d2h;

  assign tl_rom_ctrl__rom_o = tl_sm1_16_ds_h2d;
  assign tl_sm1_16_ds_d2h = tl_rom_ctrl__rom_i;

  assign tl_rv_dm__mem_o = tl_sm1_17_ds_h2d;
  assign tl_sm1_17_ds_d2h = tl_rv_dm__mem_i;

  assign tl_sram_ctrl_main__ram_o = tl_sm1_18_ds_h2d;
  assign tl_sm1_18_ds_d2h = tl_sram_ctrl_main__ram_i;

  assign tl_sram_ctrl_ret_aon__ram_o = tl_sm1_19_ds_h2d;
  assign tl_sm1_19_ds_d2h = tl_sram_ctrl_ret_aon__ram_i;

  assign tl_s1n_20_us_h2d = tl_rv_core_ibex__cored_i;
  assign tl_rv_core_ibex__cored_o = tl_s1n_20_us_d2h;

  assign tl_rom_ctrl__regs_o = tl_sm1_21_ds_h2d;
  assign tl_sm1_21_ds_d2h = tl_rom_ctrl__regs_i;

  assign tl_rv_dm__regs_o = tl_sm1_22_ds_h2d;
  assign tl_sm1_22_ds_d2h = tl_rv_dm__regs_i;
  ...
  assign tl_spi_host0_o = tl_asf_25_ds_h2d;
  assign tl_asf_25_ds_d2h = tl_spi_host0_i;
  ...
  assign tl_sram_ctrl_main__regs_o = tl_sm1_28_ds_h2d;
  assign tl_sm1_28_ds_d2h = tl_sram_ctrl_main__regs_i;

  assign tl_rv_core_ibex__cfg_o = tl_sm1_29_ds_h2d;
  assign tl_sm1_29_ds_d2h = tl_rv_core_ibex__cfg_i;

  assign tl_sram_ctrl_ret_aon__regs_o = tl_sm1_30_ds_h2d;
  assign tl_sm1_30_ds_d2h = tl_sram_ctrl_ret_aon__regs_i;

  assign tl_s1n_31_us_h2d = tl_rv_dm__sba_i;
  assign tl_rv_dm__sba_o = tl_s1n_31_us_d2h;
