...
module rv_plic_reg_top (
  ...
  always_comb begin
    ...
    addr_hit[144] = (reg_addr == RV_PLIC_IP_0_OFFSET);
    addr_hit[145] = (reg_addr == RV_PLIC_IP_1_OFFSET);
    addr_hit[146] = (reg_addr == RV_PLIC_IP_2_OFFSET);
    addr_hit[147] = (reg_addr == RV_PLIC_IP_3_OFFSET);
    addr_hit[148] = (reg_addr == RV_PLIC_IP_4_OFFSET);
    addr_hit[149] = (reg_addr == RV_PLIC_IE0_0_OFFSET);
    addr_hit[150] = (reg_addr == RV_PLIC_IE0_1_OFFSET);
    addr_hit[151] = (reg_addr == RV_PLIC_IE0_2_OFFSET);
    addr_hit[152] = (reg_addr == RV_PLIC_IE0_3_OFFSET);
    addr_hit[153] = (reg_addr == RV_PLIC_IE0_4_OFFSET);
    ...
    addr_hit[157] = (reg_addr == RV_PLIC_ALERT_TEST_OFFSET);
  end
  ...
  assign ie0_0_we = addr_hit[149] & reg_we & !reg_error;
  ...
  assign ie0_1_we = addr_hit[150] & reg_we & !reg_error;
  ...
  assign ie0_2_we = addr_hit[151] & reg_we & !reg_error;
  ...
  assign ie0_3_we = addr_hit[152] & reg_we & !reg_error;
  ...
  assign ie0_4_we = addr_hit[153] & reg_we & !reg_error;
  ...
  assign threshold0_we = addr_hit[154] & reg_we & !reg_error;

  assign threshold0_wd = reg_wdata[1:0];
  assign cc0_re = addr_hit[155] & reg_re & !reg_error;
  assign cc0_we = addr_hit[155] & reg_we & !reg_error;

  assign cc0_wd = reg_wdata[7:0];
  assign msip0_we = addr_hit[156] & reg_we & !reg_error;

  assign msip0_wd = reg_wdata[0];
  assign alert_test_we = addr_hit[157] & reg_we & !reg_error;
  ...
  always_comb begin
    ...
    reg_we_check[149] = ie0_0_we;
    reg_we_check[150] = ie0_1_we;
    reg_we_check[151] = ie0_2_we;
    reg_we_check[152] = ie0_3_we;
    reg_we_check[153] = ie0_4_we;
    reg_we_check[154] = threshold0_we;
    reg_we_check[155] = cc0_we;
    reg_we_check[156] = msip0_we;
    reg_we_check[157] = alert_test_we;
  end
